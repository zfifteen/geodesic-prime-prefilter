...
the exact DNI-to-zeta compression, and the pole-placement language that gives
the RH-facing sentence.
...
workbench where bridge details, open proof obligations, and draft technical
artifacts live.
