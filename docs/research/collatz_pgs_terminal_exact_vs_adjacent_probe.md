...
- Probe: `benchmarks/python/predictor/collatz_pgs_terminal_exact_vs_adjacent_probe.py`
- Contract test: `tests/python/predictor/test_collatz_pgs_terminal_exact_vs_adjacent_probe.py`
