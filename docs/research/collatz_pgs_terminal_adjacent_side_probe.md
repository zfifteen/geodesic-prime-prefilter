...
- Probe: `benchmarks/python/predictor/collatz_pgs_terminal_adjacent_side_probe.py`
- Contract test: `tests/python/predictor/test_collatz_pgs_terminal_adjacent_side_probe.py`
