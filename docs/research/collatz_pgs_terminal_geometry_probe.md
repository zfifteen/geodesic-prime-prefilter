...
- Probe: `benchmarks/python/predictor/collatz_pgs_terminal_geometry_probe.py`
- Contract test: `tests/python/predictor/test_collatz_pgs_terminal_geometry_probe.py`
