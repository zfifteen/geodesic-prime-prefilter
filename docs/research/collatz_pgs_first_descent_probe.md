...
- Probe: `benchmarks/python/predictor/collatz_pgs_first_descent_probe.py`
- Contract test: `tests/python/predictor/test_collatz_pgs_first_descent_probe.py`
...
- Plot: `output/collatz_pgs_first_descent_probe/collatz_pgs_first_descent_profile.png`
