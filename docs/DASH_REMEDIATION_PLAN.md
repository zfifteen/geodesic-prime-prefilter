...
**Goal:** Completely eliminate all instances of en dashes (` to `) and em dashes (`:`) across the repository while maintaining grammatical correctness, technical precision, and the conversational prose style mandated by `AGENTS.md`.
...
*   **Commands to Run:**
    *   `rg -c ":| to " README.md docs/OVERVIEW.md PROOF.md` (baseline count)
