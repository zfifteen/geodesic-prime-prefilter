# Pre-Execution Compliance Certification Request Round 04
...
## Final Correction Applied From Round 03

The `PUBLIC_FREEZE_RECORD` gate now prints:

- `original_space_size`
- `candidate_reduction_ratio`
- `candidate_reduction_bits`

immediately after `public_record_count` and before `public_nominations_summary`.
