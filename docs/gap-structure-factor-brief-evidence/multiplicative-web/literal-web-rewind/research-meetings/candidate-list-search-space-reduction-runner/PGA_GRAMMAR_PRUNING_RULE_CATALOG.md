...
These target the specific motif families observed to cause coverage gaps / low reduction in 64–80 bit real-derivation probes: a4_d4 (various prev), o4_d4_a6_d4_odd / o2_d4_a6_d4_odd / o6_d4_a6_d4_odd (a4_d4_a6 and o2/o4/o6_d4_a6 families), and high-a a8/a10 with specific @mid + d4_odd prev contexts. (Complements the earlier high-a broad rules PG-061+ and the PG-082–084 descriptions that referenced a4/a6 but were high_a-tagged.)
...
**Traceability**: Supporting per-row data in the enriched_rows.jsonl files under the pedk/.../core-evidence/output/ enriched_multiplication_map_corpus_* directories. No new surfaces created; purely re-mining of existing 27k–35k+ bands for the priority gap families. All new rules appended to PRUNING_RULES with provenance comments.
