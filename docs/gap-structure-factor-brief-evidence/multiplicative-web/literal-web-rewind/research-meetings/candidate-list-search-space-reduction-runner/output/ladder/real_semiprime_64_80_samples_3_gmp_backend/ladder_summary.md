...
**Date**: 2026-05-23T02:57:27.573237+00:00
**Mode**: `real`
...
|------|---------------|---------|-----|-----|------------|
| 64 | 35.19% | 18.41% | 15.2% | 59.6% | 0 |
| 72 | 49.50% | 24.96% | 15.2% | 73.7% | 0 |
| 80 | 20.37% | 7.38% | 15.2% | 30.8% | 0 |
...
- Resolved cases: 9
- Unresolved cases: 0
- Average reduction (all cases): 35.02%
- Average reduction (resolved cases): 35.02%
- Min / Max reduction: 15.15% / 73.74%
- Motifs with coverage gaps: 4
...
| case_id | N | motif | source | factors_discarded | rules | pruned | remaining | % | status | gap | error |
|---------|---|-------|--------|-------------------|-------|--------|-----------|---|--------|-----|-------|
| semiprime_80_0 | 302232031384200830517547 | `o6_d4_a6_d4_odd@mid + o2_d4_odd prev` | derive_public_motif(N_only) | yes | PG-009,PG-012,PG-021,PG-025,PG-029,PG-033,PG-037,PG-057,PG-085 | 61 | 137 | 30.81% | resolved | no | - |
| semiprime_80_1 | 302233184299108378083419 | `o2_d4_a6_d4_odd@mid + o4_higher_divisor_odd prev` | derive_public_motif(N_only) | yes | PG-088 | 30 | 168 | 15.15% | resolved | yes | - |
| semiprime_80_2 | 302234337229409109409939 | `o4_d4_a6_d4_odd@mid + o6_d4_odd prev` | derive_public_motif(N_only) | yes | PG-089 | 30 | 168 | 15.15% | resolved | yes | - |
