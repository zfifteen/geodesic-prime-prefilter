...
```text
python3 experiments/collatz/scripts/collatz_prime_gap_divisor_demo.py --limit 100000
```

For a fast smoke run:

```text
python3 experiments/collatz/scripts/collatz_prime_gap_divisor_demo.py --limit 20000
```
...
```text
experiments/collatz/output/collatz_pgs_same_gap_scale_probe/block_rows.jsonl
```

It is reproducible from:

```text
python3 experiments/collatz/scripts/collatz_pgs_same_gap_scale_probe.py --limit 1000000
```
