...
```text
experiments/rsa/v2/run_experiment.py
```
...
experiments/rsa/v2/SESSION_BOOTSTRAP.md
experiments/rsa/v2/AGENTS.md
experiments/rsa/v2/TRANSPORTED_STORY_LAW_PROOF_OBLIGATIONS.md
experiments/rsa/v2/output/inference_rows.jsonl
experiments/rsa/v2/output/survivor_rows.jsonl
experiments/rsa/v2/output/summary.json
experiments/rsa/v2/output/audit_results.csv
experiments/rsa/v2/output/toy_normalized_frontier_closure_sweep_current/
```
...
python3 experiments/rsa/v2/toy_normalized_frontier_closure_sweep.py --output-dir experiments/rsa/v2/output/toy_normalized_frontier_closure_sweep_current
```
