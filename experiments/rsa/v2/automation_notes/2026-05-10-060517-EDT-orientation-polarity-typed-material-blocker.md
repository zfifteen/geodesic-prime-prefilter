...
```bash
python3 experiments/rsa/v2/transported_story_law_probe.py \
  --cases experiments/rsa/v2/fixtures/ladder_cases.jsonl \
  --measured-rows 256 \
  --recursive-depth 4 \
  --output-dir experiments/rsa/v2/output/transported_story_law_current
```
...
experiments/rsa/v2/automation_notes/2026-05-10-060517-EDT-orientation-polarity-typed-material-blocker.md
experiments/rsa/v2/output/transported_story_law_current/summary.json
experiments/rsa/v2/output/transported_story_law_current/story_law_rows.jsonl
experiments/rsa/v2/output/transported_story_law_current/recursive_rows.jsonl
```

`experiments/rsa/v2/AGENTS.md` was restored because it was missing in this
