...
**Strongest supported claim (this surface):** Harness **L0** (GWR-offset confound) matched `q_ref` on **0 / 78 493** gaps. Semantic-independence audit **passed**. No substantive law **L1–L4** achieved early forced closure with a correct endpoint (`any_law_early_support_count = 0`).
