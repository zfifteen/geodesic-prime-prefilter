...
| F2 | p90(\(\delta\)) not non-increasing across buckets \(\tau=4,6\text{ to }7,8\text{ to }11,12\text{ to }23,\ge 24\) | Monotonic tightening fails |
...
| 6 to 7 | 5,432 | 3 | 5 | 20 | 3.11 |
| 8 to 11 | 15,607 | 2 | 3 | 8 | 2.03 |
| 12 to 23 | 6,320 | 1 | 2 | 5 | 1.36 |
...
| --- | ---: | ---: | ---: | ---: |
| \(10^2\) to \(10^3\) | 4 | 6 | 1 | 1 |
| \(10^3\) to \(10^4\) | 5 | 10 | 1 | 1 |
| \(10^4\) to \(10^5\) | 6 | 16 | 1 | 3 |
| \(10^5\) to \(10^6\) | 6 | 22 | 1 | 5 |
| \(10^6\) to \(10^7\) | 6 | 24 | 1 | 3 |

Low-\(\tau\) tails lengthen with scale; high-\(\tau\) medians remain at 1.

**Falsification outcomes.** F1 to F5: all pass. Overall verdict: \(H_{\mathrm{LB}}\) **not falsified** in the tested regime.
...
3. **Falsification probe script.** `simplest_composite_left_bias_probe.py`: executable audit with pre-registered F1 to F5 checks.  
