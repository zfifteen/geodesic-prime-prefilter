...
SOURCE_PATH="$ROOT_DIR/src/BouncyCastlePrimeSampleBehaviorProbe.java"
OUTPUT_PATH="${1:-$ROOT_DIR/results/bcprov-jdk18on-1.83-source-r1rv83-prime-sample-behavior-seed-byte-42.json}"
...
JAVA_HOME="$BC_RUNTIME_JAVA_HOME" PATH="$BC_RUNTIME_JAVA_HOME/bin:$PATH" \
  java \
    ...
    BouncyCastlePrimeSampleBehaviorProbe \
    "$OUTPUT_PATH"
