...
PARALLEL_SCRIPT_PATH = ROOT / "research" / "02-gwr-dni" / "scripts" / "proof" / "parallel_no_early_spoiler_scan.py"
MARGIN_SCRIPT_PATH = ROOT / "research" / "02-gwr-dni" / "scripts" / "proof" / "no_early_spoiler_margin_scan.py"
BRIDGE_SCRIPT_PATH = ROOT / "research" / "02-gwr-dni" / "scripts" / "proof" / "asymptotic_bridge_load_scan.py"
