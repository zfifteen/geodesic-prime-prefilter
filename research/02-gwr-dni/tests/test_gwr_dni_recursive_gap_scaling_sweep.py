...
SWEEP_MODULE_PATH = (
    ROOT / "research" / "02-gwr-dni" / "scripts" / "gwr_dni_recursive_gap_scaling_sweep.py"
)
PLOT_MODULE_PATH = (
    ROOT / "research" / "02-gwr-dni" / "scripts" / "plot_gwr_dni_recursive_gap_scaling_sweep.py"
)
...
def test_scaling_sweep_uses_dynamic_cutoff():
    ...
    module = load_module("gwr_dni_recursive_gap_scaling_sweep", SWEEP_MODULE_PATH)
    walk_module = load_module("gwr_dni_recursive_walk", ROOT / "research" / "02-gwr-dni" / "scripts" / "gwr_dni_recursive_walk.py")
