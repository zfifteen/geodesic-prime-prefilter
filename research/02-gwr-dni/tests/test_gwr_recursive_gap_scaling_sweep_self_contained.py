...
MODULAR_MODULE_PATH = ROOT / "research" / "02-gwr-dni" / "scripts" / "gwr_recursive_gap_scaling_sweep.py"
SELF_CONTAINED_MODULE_PATH = (
    ROOT / "research" / "02-gwr-dni" / "scripts" / "gwr_recursive_gap_scaling_sweep_self_contained.py"
)
