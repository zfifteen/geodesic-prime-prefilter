...
DEFAULT_ROWS_PATHS = (
    Path("research/01-generator/output/simple_pgs_chain_horizon_closure_1e12_exact_sweep/rows.jsonl"),
    Path("research/01-generator/output/simple_pgs_chain_horizon_closure_high_scale_probe/rows.jsonl"),
)
DEFAULT_SCALE_SUMMARY_PATHS = (
    Path("research/01-generator/output/simple_pgs_chain_horizon_closure_1e12_exact_sweep/summary.json"),
    Path("research/01-generator/output/simple_pgs_chain_horizon_closure_high_scale_probe/summary.json"),
)
DEFAULT_PER_ANCHOR_ROWS = {
    10**12: Path("research/01-generator/output/simple_pgs_chain_horizon_closure_1e12_probe/rows.jsonl"),
    10**15: Path("research/01-generator/output/simple_pgs_chain_horizon_closure_high_scale_probe/rows.jsonl"),
    10**18: Path("research/01-generator/output/simple_pgs_chain_horizon_closure_high_scale_probe/rows.jsonl"),
}
