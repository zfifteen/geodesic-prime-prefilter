...
```bash
python3 research/01-generator/scripts/prime_inference_generator/composite_exclusion_boundary_probe.py --start-anchor 11 --max-anchor 10000 --candidate-bound 64 --enable-single-hole-positive-witness-closure --witness-bound 97 --enable-carrier-locked-pressure-ceiling --carrier-lock-predicate <predicate> --output-dir <output-dir>
```
