...
$$
\text{for every prime } p,\ \text{pgs chamber reset v1}(p)=q
$$
...
$$
g \le H \Longrightarrow \text{pgs chamber reset v1}(p, H) = q
$$
...
$$
\text{lower d threat offset} \ge g \quad \text{or} \quad \text{lower d threat offset} = \varnothing.
$$
...
$$
\text{lower d threat offset} < \text{gap offset}
$$
