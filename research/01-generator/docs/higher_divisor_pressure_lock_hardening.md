...
- `../../../research/01-generator/scripts/prime_inference_generator/higher_divisor_pressure_lock_rule refinement.py`
...
```bash
python3 research/01-generator/scripts/prime_inference_generator/higher_divisor_pressure_lock_rule refinement.py --start-anchor 11 --max-anchors 10000 100000 1000000 --candidate-bound 64 --witness-bound 97 --output-dir /tmp/pgs_hd_lock_rule refinement_1m
```
...
```bash
python3 research/01-generator/scripts/prime_inference_generator/composite_exclusion_boundary_probe.py --start-anchor 11 --max-anchor 100000 --candidate-bound 64 --witness-bound 97 --enable-single-hole-positive-witness-closure --enable-carrier-locked-pressure-ceiling --carrier-lock-predicate unresolved_alternatives_before_threat --enable-higher-divisor-pressure-locked-absorption --output-dir /tmp/pgs_hd_locked_absorption_integration_100000
```
