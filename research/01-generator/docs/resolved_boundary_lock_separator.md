...
- `../../../research/01-generator/scripts/prime_inference_generator/resolved_boundary_lock_separator_probe.py`
...
```bash
python3 research/01-generator/scripts/prime_inference_generator/resolved_boundary_lock_separator_probe.py --start-anchor 11 --max-anchor 10000 --candidate-bound 64 --witness-bound 97 --output-dir /tmp/pgs_resolved_lock_separator_10000_b64_w97
```
