...
- `../../../research/01-generator/scripts/prime_inference_generator/unresolved_alternative_closure_forensics.py`
...
```bash
python3 research/01-generator/scripts/prime_inference_generator/unresolved_alternative_closure_forensics.py --start-anchor 11 --max-anchor 10000 --candidate-bound 64 --witness-bound 97 --output-dir /tmp/pgs_unresolved_alt_closure_10000_b64_w97
```
