...
```text
research/01-generator/scripts/prime_inference_generator/experimental_graph_prime_generator.py
```
...
```text
research/01-generator/scripts/prime_inference_generator/witness_horizon_semiprime_analysis.py
```

Run the documented horizon sequence:

```bash
python3 research/01-generator/scripts/prime_inference_generator/witness_horizon_semiprime_analysis.py \
  --start-anchor 11 \
  --max-anchor 100000 \
  --candidate-bound 128 \
...
python3 research/01-generator/scripts/prime_inference_generator/experimental_graph_prime_generator.py \
