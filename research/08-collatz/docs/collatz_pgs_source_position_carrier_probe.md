...
```text
docs/collatz_pgs_terminal_contact_decomposition_probe.md
```
...
- Probe: `scripts/collatz_pgs_source_position_carrier_probe.py`
- Contract test: `tests/test_collatz_pgs_source_position_carrier_probe.py`
