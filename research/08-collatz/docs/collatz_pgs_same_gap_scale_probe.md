...
- Probe: `scripts/collatz_pgs_same_gap_scale_probe.py`
- Contract test: `tests/test_collatz_pgs_same_gap_scale_probe.py`
...
```text
docs/collatz_pgs_reset_length_strata_probe.md
```
