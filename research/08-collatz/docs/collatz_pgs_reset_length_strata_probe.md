...
- Probe: `scripts/collatz_pgs_reset_length_strata_probe.py`
- Contract test: `tests/test_collatz_pgs_reset_length_strata_probe.py`
...
```text
docs/collatz_pgs_reset_carrier_strata_probe.md
```
