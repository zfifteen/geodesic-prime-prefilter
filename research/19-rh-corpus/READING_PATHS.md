...
**Audience:** General; infographic or whitepaper followers  
...
> PGS proves integer-level gap structure and exact compression into zeta
> language. Placing every nontrivial pole on the critical line, the RH
> sentence, remains an open placement step in the program.

**Avoid on X:** [RH-033](../pgs-rh-placement-empirics-2026-06/pgs_d4_frac_pos_falsification_1000000.json) (invalidated), [RH-090](../12-rh-bridge/README.md) to [RH-092](../12-rh-bridge/README.md) (archived machinery), [RH-051](../../docs/rh/status-ledger.md) without boundary.

---

## Reviewer / skeptic (status-first)

**Audience:** Mathematician checking category errors  
**Time:** 30 to 45 minutes

1. [docs/rh/reviewer-map.md](../../docs/rh/reviewer-map.md)  
2. [RH-100](../../docs/rh/status-ledger.md). Status ledger  
3. [RH-001](../../PROOF.md), [RH-002](../../PROOF.md), [RH-003](../../PROOF.md). Proved source only  
4. [RH-020](../../docs/rh/dni-to-zeta-compression.md), [RH-021](../../docs/rh/dni-to-zeta-compression.md). Exact compression  
5. [RH-050](../../docs/rh/off-critical-pole-exclusion.md), [RH-051](../../docs/rh/status-ledger.md). Unresolved target + obstruction  
6. [RH-033](../pgs-rh-placement-empirics-2026-06/pgs_d4_frac_pos_falsification_1000000.json). Invalidated row (shows honesty on placement conjectures)  

**Do not start at:** [RH-042](../../docs/essays/the-riemann-hypothesis-is-obsolete.md), [RH-052](../../docs/rh/critical-line-and-zero-geometry.md), [RH-041](../../experiments/integer-order-before-zeta-whitepaper-2026-07/WHITEPAPER.md) (narrative: read after proved rows).
...
1. [RH-001](../../PROOF.md) to [RH-003](../../PROOF.md) : [PROOF.md](../../PROOF.md) pillars  
2. [RH-080](../../lean-4/PGS/Placement.lean) : `lean-4/PGS/Placement.lean`  
3. [RH-081](../../lean-4/pgs-rh-placement-invariants.lean) : `lean-4/pgs-rh-placement-invariants.lean`  
4. [docs/proof-enhancements/lean-readiness.md](../../docs/proof-enhancements/lean-readiness.md)  

---

## Deep program narrative (essay path)
