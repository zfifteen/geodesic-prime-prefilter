...
50-bit rung under the v2 runner stayed unresolved; rsa-v3 V3 carrier reciprocal
closure (2026-08-07) finds the public pair (32047633, 32059651) under
resolved_by_carrier_reciprocal_closure (measured-on-regime-only / hypothesis).
```

Residual codes (measured history; V3 resolve path):
...
rsa-v3 joint residual R: unresolved_by_joint_cell_C1T2L1
rsa-v3 V3 carrier reciprocal (2026-08-07): resolved_by_carrier_reciprocal_closure
  endpoint_class = [32047633, 32059651]
  package: research/06-cryptology-rsa/experiments/live-solver/rsa-v3/residual_discriminator_v2/
...
universal RSA-scale theorem. Residual maps (D, residual cell R) remain hypothesis.
V3 path is measured-on-regime-only / hypothesis; not a factorisation claim.
```
