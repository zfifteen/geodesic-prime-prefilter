...
- Fixed near-540 band `D(r) in [528, 552]` as a law on utilization maxima
...
Measured residual holds RC3-RC29 on util maxima through `4e8-5e8` + o_q panel
are audit only. Latest residual surface this hour: RC27-RC29 (max/mean, gap CV,
Dual/mean units) under
`experiments/square-branch-hourly-2026-07-13-rc27/`.
