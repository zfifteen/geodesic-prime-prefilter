...
| --- | --- | --- | --- |
| `01-generator` | mapped | `python3 -m pytest tests/python/predictor/test_simple_pgs_generator.py tests/python/predictor/test_gwr_dni_recursive_walk.py` passed, 36 tests | Production code remains in place. |
| `02-gwr-dni` | mapped | `python3 -m pytest tests/python/predictor/test_simple_pgs_generator.py tests/python/predictor/test_gwr_dni_recursive_walk.py` passed, 36 tests | GWR/DNI evidence routed. |
