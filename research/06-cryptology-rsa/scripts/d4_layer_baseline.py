...
DEFAULT_OUTPUT_DIR = ROOT / "research" / "06-cryptology-rsa" / "output" / "semiprime_branch"
DEFAULT_D4_SUMMARY_PATH = ROOT / "research" / "02-gwr-dni" / "output" / "gwr_d4_arrival_validation_summary.json"
DEFAULT_D4_EXACT_CSV_PATH = ROOT / "research" / "02-gwr-dni" / "output" / "gwr_d4_arrival_validation_exact.csv"
DEFAULT_D4_EVEN_CSV_PATH = ROOT / "research" / "02-gwr-dni" / "output" / "gwr_d4_arrival_validation_even_bands.csv"
DEFAULT_PREFILTER_BENCHMARKS_PATH = (
    ROOT / "research" / "06-cryptology-rsa" / "legacy-prefilter" / "output" / "prefilter" / "benchmark_results.json"
)
