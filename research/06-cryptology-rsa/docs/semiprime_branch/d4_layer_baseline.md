...
```text
research/06-cryptology-rsa/output/semiprime_branch/d4_layer_baseline_summary.json
```

paired with:

```text
research/06-cryptology-rsa/output/semiprime_branch/d4_layer_baseline_by_scale.csv
```
