...
DEFAULT_OUTPUT_DIR = (
    ROOT / "research" / "06-cryptology-rsa" / "legacy-prefilter" / "output" / "prefilter" / "structural_amplification"
)
...
def run_verification(
    ...
    results = {
        ...
        "reproduction_command": (
            "python3 research/06-cryptology-rsa/legacy-prefilter/scripts/structural_amplification_verifier.py "
