...
```bash
python3 research/06-cryptology-rsa/legacy-prefilter/scripts/table_depth_sweep.py --output-dir research/06-cryptology-rsa/legacy-prefilter/output/prefilter/table_depth_sweep --bit-lengths 2048 4096 8192 16384 --table-limits 300007 1000003 3000000 --candidate-count 4096 --chunk-size 256 --primary-limit 200003 --tail-limit 300007 --namespace cdl-table-depth-sweep
```
