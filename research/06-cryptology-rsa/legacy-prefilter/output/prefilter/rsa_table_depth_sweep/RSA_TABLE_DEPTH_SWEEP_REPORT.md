...
```bash
python3 research/06-cryptology-rsa/legacy-prefilter/scripts/rsa_table_depth_sweep.py --output-dir research/06-cryptology-rsa/legacy-prefilter/output/prefilter/rsa_table_depth_sweep --rsa-bits 8192 --keypair-count 2 --table-limits 300007 1000003 3000000 --chunk-size 256 --primary-limit 200003 --tail-limit 300007 --public-exponent 65537 --namespace cdl-rsa-table-depth-sweep
```
