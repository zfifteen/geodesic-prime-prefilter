...
- [DNI Near-Endpoint Raw-Z Peak](../research/11-gap-ridge/docs/dni_gap_ridge.md)
- [Exact Raw Composite Z Score Values: Gap-Edge Ridge Study](../research/11-gap-ridge/docs/gap_ridge/raw_composite_z_gap_edge.md)
- [Lexicographic Winner-Take-All Peak Rule](../research/11-gap-ridge/docs/findings/lexicographic_winner_take_all_peak_rule.md)
- [Residue-Modulated Ridge Orientation](../research/11-gap-ridge/docs/gap_ridge/residue_mod30_ridge_orientation_note.md)
