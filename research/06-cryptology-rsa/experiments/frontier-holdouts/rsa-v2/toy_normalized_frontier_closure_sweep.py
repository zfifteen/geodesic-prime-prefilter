...
TRANSPORTED_DIR = EXPERIMENTS_DIR / "transported-sidecars" / "rsa-v2"
RULE_ID = "toy_normalized_frontier_closure_sweep_v1"
DEFAULT_BUDGET_ROWS = TRANSPORTED_DIR / "output" / "transported_d4_budget_current" / "budget_rows.jsonl"
DEFAULT_TRACE_ROWS = TRANSPORTED_DIR / "output" / "transported_d4_budget_trace_current" / "trace_rows.jsonl"
DEFAULT_INFERENCE_ROWS = LIVE_SOLVER_DIR / "output" / "inference_rows.jsonl"
