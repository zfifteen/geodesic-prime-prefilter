...
```text
research/06-cryptology-rsa/experiments/rsa/v2/modulus_gap_grammar_probe.py
```

Public artifact:

```text
research/06-cryptology-rsa/experiments/rsa/v2/output/modulus_gap_grammar/public_grammar_rows.jsonl
```

Downstream target-label artifact:

```text
research/06-cryptology-rsa/experiments/rsa/v2/output/modulus_gap_grammar/target_correlation_rows.jsonl
```

Summary artifact:

```text
research/06-cryptology-rsa/experiments/rsa/v2/output/modulus_gap_grammar/summary.json
```

Expanded catalog artifact:

```text
research/06-cryptology-rsa/experiments/rsa/v2/output/modulus_gap_grammar_catalog/public_grammar_rows.jsonl
research/06-cryptology-rsa/experiments/rsa/v2/output/modulus_gap_grammar_catalog/target_correlation_rows.jsonl
research/06-cryptology-rsa/experiments/rsa/v2/output/modulus_gap_grammar_catalog/summary.json
```
...
```text
research/06-cryptology-rsa/scripts/midscale_balanced_corpus.json
research/06-cryptology-rsa/scripts/scaleup_corpus.json
```
