...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--rsa-public-rows",
        type=Path,
        default=MODULUS_DIR / "output" / "rsa_challenge_exact_grammar" / "public_grammar_rows.jsonl",
        help="Solved RSA challenge public grammar rows.",
    )
    parser.add_argument(
        "--rsa-target-rows",
        type=Path,
        default=MODULUS_DIR / "output" / "rsa_challenge_exact_grammar" / "target_grammar_rows.jsonl",
