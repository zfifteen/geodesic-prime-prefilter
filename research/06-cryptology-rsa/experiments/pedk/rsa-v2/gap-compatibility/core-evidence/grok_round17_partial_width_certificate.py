#!/usr/bin/env python3
"""Grok Round 17 finite-scope landing certificate for the a10 width obstruction."""
...
OUTPUT_DIR = THIS_DIR / "output" / "grok_round17_partial_width_certificate"
RULE_ID = "pedk_grok_round17_partial_width_certificate_v1"
