#!/usr/bin/env python3
"""Round 9 component audit for the public signature phase obstruction."""
...
OUTPUT_DIR = THIS_DIR / "output" / "codex_round9_public_component_obstruction_audit"
RULE_ID = "pedk_codex_round9_public_component_obstruction_audit_v1"
DIRECTED_TUPLES = {
    ("even", "mid", "o4"),
    ("odd", "early", "o6"),
}
...
def summary(cascades: list[dict[str, object]]) -> dict[str, object]:
    ...
    return {
        "rule_id": RULE_ID,
        "status": "measured_public_component_obstruction_audit",
