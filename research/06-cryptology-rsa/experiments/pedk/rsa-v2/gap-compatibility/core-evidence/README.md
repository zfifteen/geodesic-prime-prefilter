...
active_surface = public at-winner condition -> right-following endpoint classes
active_candidate_law = clean right-following classes exclude exact endpoint-pair cells
```
