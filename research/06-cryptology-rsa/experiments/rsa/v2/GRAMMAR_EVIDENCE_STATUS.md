...
```text
research/06-cryptology-rsa/experiments/rsa/v2/output/grammar_evidence/exact_low_regime_grammar_rows.jsonl
```
...
```text
research/06-cryptology-rsa/experiments/rsa/v2/output/rsa_challenge_exact_grammar/
```
...
```text
research/06-cryptology-rsa/experiments/rsa/v2/output/grammar_compatibility/
```
