...
```text
research/06-cryptology-rsa/experiments/rsa/v2/output/toy_endpoint_chain_closure_current/toy_cases.jsonl
research/06-cryptology-rsa/experiments/rsa/v2/output/toy_endpoint_chain_closure_current/inference/
research/06-cryptology-rsa/experiments/rsa/v2/output/toy_endpoint_chain_closure_current/transported_story_law/
research/06-cryptology-rsa/experiments/rsa/v2/output/toy_endpoint_chain_closure_current/transported_d4_budget/
research/06-cryptology-rsa/experiments/rsa/v2/output/toy_endpoint_chain_closure_current/transported_d4_budget_trace/
research/06-cryptology-rsa/experiments/rsa/v2/output/toy_endpoint_chain_closure_current/pre_first_closure_defect_summary.json
research/06-cryptology-rsa/experiments/rsa/v2/output/toy_endpoint_chain_closure_current/endpoint_pair_holdout_rows.jsonl
research/06-cryptology-rsa/experiments/rsa/v2/output/toy_endpoint_chain_closure_current/endpoint_pair_holdout_summary.json
```
...
```text
research/06-cryptology-rsa/experiments/rsa/v2/automation_notes/2026-05-12-061636-EDT-toy-endpoint-chain-closure-blocker.md
```
