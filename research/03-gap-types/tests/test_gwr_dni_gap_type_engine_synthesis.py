...
MODULE_PATH = ROOT / "research" / "03-gap-types" / "scripts" / "gwr_dni_gap_type_engine_synthesis.py"
...
def test_build_summary_freezes_expected_profiles():
    ...
    summary = module.build_summary(
        generative=module.load_json(ROOT / "research" / "03-gap-types" / "output" / "gwr_dni_gap_type_generative_probe_summary.json"),
        decode=module.load_json(ROOT / "research" / "03-gap-types" / "output" / "gwr_dni_gap_type_engine_decode_summary.json"),
        scheduler=module.load_json(ROOT / "research" / "03-gap-types" / "output" / "gwr_dni_gap_type_scheduler_probe_summary.json"),
        hybrid=module.load_json(ROOT / "research" / "03-gap-types" / "output" / "gwr_dni_gap_type_hybrid_scheduler_probe_summary.json"),
        long_horizon=module.load_json(
            ROOT / "research" / "03-gap-types" / "output" / "gwr_dni_gap_type_long_horizon_controller_probe_summary.json"
        ),
    )
