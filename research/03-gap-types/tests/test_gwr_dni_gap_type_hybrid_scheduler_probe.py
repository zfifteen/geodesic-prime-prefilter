...
MODULE_PATH = ROOT / "research" / "03-gap-types" / "scripts" / "gwr_dni_gap_type_hybrid_scheduler_probe.py"
...
def test_hybrid_summary_improves_pooled_window_fit_but_not_stationary_gap():
    ...
    module = load_module()
    rows = module.GEN_PROBE.load_rows(ROOT / "research" / "03-gap-types" / "output" / "gwr_dni_gap_type_catalog_details.csv")
