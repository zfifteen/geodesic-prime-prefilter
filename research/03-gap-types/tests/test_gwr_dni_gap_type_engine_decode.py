...
MODULE_PATH = ROOT / "research" / "03-gap-types" / "scripts" / "gwr_dni_gap_type_engine_decode.py"
...
def test_decode_rulebook_returns_bounded_rules_on_real_support():
    ...
    module = load_module()
    detail_rows = module.GEN_PROBE.load_rows(ROOT / "research" / "03-gap-types" / "output" / "gwr_dni_gap_type_catalog_details.csv")
