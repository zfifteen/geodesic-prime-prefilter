...
GWR_WALK_PATH = ROOT / "research" / "02-gwr-dni" / "scripts" / "gwr_dni_recursive_walk.py"
GWR_WALK_SPEC = importlib.util.spec_from_file_location("gwr_dni_recursive_walk", GWR_WALK_PATH)
if GWR_WALK_SPEC is None or GWR_WALK_SPEC.loader is None:
    raise RuntimeError("unable to load gwr_dni_recursive_walk")
GWR_WALK = importlib.util.module_from_spec(GWR_WALK_SPEC)
GWR_WALK_SPEC.loader.exec_module(GWR_WALK)
dynamic_cutoff = GWR_WALK.dynamic_cutoff
first_open_offset = GWR_WALK.first_open_offset
