...
SHARED_SCRIPT_DIR = ROOT / "research" / "00-index" / "scripts"
for _path in (SCRIPT_DIR, SHARED_SCRIPT_DIR):
...
DEFAULT_DETAIL_CSV = ROOT / "research" / "04-bounded-compression" / "output" / "gwr_dni_gap_type_catalog_details.csv"
