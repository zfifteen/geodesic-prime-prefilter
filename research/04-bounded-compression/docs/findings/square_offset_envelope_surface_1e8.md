...
```text
research/04-bounded-compression/output/square_branch_dynamic_cutoff_search_1e8/square_branch_dynamic_cutoff_search_summary.json
research/04-bounded-compression/output/square_branch_dynamic_cutoff_search_1e8/square_branch_dynamic_cutoff_search_frontier.csv
```
