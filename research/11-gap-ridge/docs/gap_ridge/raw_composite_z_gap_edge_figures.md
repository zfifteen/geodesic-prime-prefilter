...
- `research/11-gap-ridge/output/raw_z_gap_edge/raw_z_gap_edge_run_all.json`
- `research/11-gap-ridge/scripts/raw_z_gap_edge_plots.py`
...
![Regime enrichment confirmation](../../research/11-gap-ridge/output/raw_z_gap_edge/regime_enrichment_2d.svg)
...
![Observed versus baseline edge-distance distribution](../../research/11-gap-ridge/output/raw_z_gap_edge/edge_distance_distribution_2d.svg)
...
![Observed versus baseline integer divisor distribution](../../research/11-gap-ridge/output/raw_z_gap_edge/carrier_divisor_distribution_2d.svg)
...
![Representative prime-gap raw-Z profile](../../research/11-gap-ridge/output/raw_z_gap_edge/representative_gap_profile_2d.svg)
...
![Gap-size by edge-distance enrichment surface](../../research/11-gap-ridge/output/raw_z_gap_edge/gap_size_edge_distance_enrichment_3d.png)
...
![Gap-size by integer-divisor enrichment surface](../../research/11-gap-ridge/output/raw_z_gap_edge/gap_size_carrier_enrichment_3d.png)
...
```bash
python3 research/11-gap-ridge/scripts/raw_z_gap_edge_run_all.py \
  > research/11-gap-ridge/output/raw_z_gap_edge/raw_z_gap_edge_run_all.json

python3 research/11-gap-ridge/scripts/raw_z_gap_edge_plots.py

python3 research/11-gap-ridge/scripts/lexicographic_peak_validation.py
```
