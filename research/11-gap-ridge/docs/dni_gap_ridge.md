...
The focused result note for the exact $10^6$ run is [research/11-gap-ridge/docs/gap_ridge/raw_composite_z_gap_edge.md](./gap_ridge/raw_composite_z_gap_edge.md).

The figure note for the broader rendered regime surface is [research/11-gap-ridge/docs/gap_ridge/raw_composite_z_gap_edge_figures.md](./gap_ridge/raw_composite_z_gap_edge_figures.md).

The session finding note for the selection rule is [research/11-gap-ridge/docs/findings/lexicographic_winner_take_all_peak_rule.md](./findings/lexicographic_winner_take_all_peak_rule.md).
