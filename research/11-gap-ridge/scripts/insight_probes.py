...
DEFAULT_OUTPUT_DIR = Path("research/11-gap-ridge/output/insight_probes")
DEFAULT_VALIDATION_JSON = Path(
    "research/11-gap-ridge/output/lexicographic_peak_validation/lexicographic_peak_validation.json"
)
