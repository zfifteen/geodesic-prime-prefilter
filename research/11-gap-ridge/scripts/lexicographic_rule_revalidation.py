...
DEFAULT_OUTPUT_DIR = ROOT / "research" / "11-gap-ridge" / "output"
    ...
    *,
    ...
    lines.extend(
        [
            ...
            f"- [`lexicographic_rule_revalidation.py`](../research/11-gap-ridge/scripts/lexicographic_rule_revalidation.py)",
            f"- [`test_lexicographic_rule_revalidation.py`](../research/11-gap-ridge/tests/test_lexicographic_rule_revalidation.py)",
            ...
            "",
            "Commands:",
            "- `python3 research/11-gap-ridge/scripts/lexicographic_rule_revalidation.py`",
            "- `pytest research/11-gap-ridge/tests/test_lexicographic_rule_revalidation.py`",
            "",
            "Environment:",
