...
def test_divisor_counts_segment_handles_large_coordinates_without_int64_overflow():
    """The global exact interval backend should handle coordinates above int64."""
    power = 1 << 80
    lo = power
    hi = lo + 1
